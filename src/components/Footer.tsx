    ...
    <footer className="relative bg-gradient-to-b from-background to-card border-t border-border/50">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
          ...
          >
            <img src={logo} alt="Preca Logo" className="h-14 w-auto mb-6 brightness-110" />
          ...
          >
            <h3 className="font-semibold text-lg mb-6 text-foreground">Servicios</h3>
            <ul className="space-y-3">
              {["PRECA INE", "PRECA Básica", "PRECA Pro", "PRECA Completa"].map((service) => (
                <li key={service}>
                  <a 
                    href="#services" 
          ...
          >
            <h3 className="font-semibold text-lg mb-6 text-foreground">Empresa</h3>
            <ul className="space-y-3">
              {[
                { label: "Asesores", href: "#advisors" },
          ...
          >
            <h3 className="font-semibold text-lg mb-6 text-foreground">Contacto</h3>
            <ul className="space-y-3">
              <li>
                <a 
                  href="tel:+529613168341" 
